...
img = Image.open('PoweredByEconARK.png')
...
xbb_content = f"""%%Title: PoweredByEconARK.png
...
urllib.request.urlretrieve(svg_url, "PoweredByEconARK.svg")
print("✅ SVG downloaded")

# 2. Download PNG
png_url = f"https://raster.shields.io/badge/{badge_params}.png"
urllib.request.urlretrieve(png_url, "PoweredByEconARK.png")
...
- `PoweredByEconARK.svg` - Vector format (best for web/README)
- `PoweredByEconARK.png` - Raster PNG (~140x20px)
- `PoweredByEconARK.jpg` - JPEG conversion
- `PoweredByEconARK.pdf` - PDF conversion
- `PoweredByEconARK.xbb` - LaTeX bounding box file
