# Vendored verbatim from llorracc/SolvingMicroDSOPs@03884752c372 Code/Python/stages/cons_noshocks.py (fetched 2026-04-22); do not edit here — update upstream and re-vendor.
